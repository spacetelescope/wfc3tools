...
The current WFC3 Data Handbook can be found `here <https://www.stsci.edu/files/live/sites/www/files/home/hst/instrumentation/wfc3/_documents/wfc3_dhb.pdf>`_.
...
.. code-block:: python
    ...
    filename = 'path/to/input/file.fits'
    calwf3(filename)
...
While both CR-SPLIT and REPEAT-OBS exposures from an association get combined using `calwf3`, dithered observations from an association will be combined using Astrodrizzle Images taken at a given dither position can be additionally CR-SPLIT (UVIS only) into multiple exposures.
...
** DRZ and DRC products are produced with 'Astrodrizzle <https://www.stsci.edu/scientific-community/software/drizzlepac.html>`_ **
